...
<tr>
<th>CustomerID</th><th>AccountID</th><th>AccountType</th><th>BranchName</th><th>Balance</th><th>status</th><th>Activate</th><th>Deactivate</th>
</tr>
...
<tr>
   ...
   <td><button  type="submit" formaction="AddAccount.jsp" formmethod="post"><c:out value="${current1.key}"/></button></td>
   ...
   <td><c:out value="${current1.value.isStatus()}"/></td>
    ...
    <td><button type="submit" formaction="Deactivate" formmethod="post">Delete</button></td>     
