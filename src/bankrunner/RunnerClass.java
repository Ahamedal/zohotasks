...
public class RunnerClass {
	...
	private void addDummyCustomerInfo() throws CustomException{
	...
	private void addDummyAccount()throws CustomException {
	...
	private void addMultiple() throws CustomException{
		Scanner sc=new Scanner(System.in);
		System.out.println("how many customers do you add");
		int count=sc.nextInt();
		sc.nextLine();
